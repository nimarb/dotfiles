...
echo -e "Start_Charge_Thresh: $(cat /sys/devices/platform/smapi/BAT0/stop_charge_tresh)" >> ~/batstats.txt
echo -e "Stop_Charge_Thresh: $(cat /sys/devices/platform/smapi/BAT0/start_charge_tresh)" >> ~/batstats.txt
